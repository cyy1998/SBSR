...
class Classifier(nn.Module):
    def __init__(self,alph,feature_size,num_classes, use_gpu=True):
        ...
        self.fc1 = nn.Sequential(nn.Linear(self.feature_size, 256),nn.BatchNorm1d(256,eps=2e-5),nn.ReLU())
        self.fc4 = nn.Sequential(nn.Linear(256, 256),nn.BatchNorm1d(256,eps=2e-5))
